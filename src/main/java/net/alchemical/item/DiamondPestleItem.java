...
public class DiamondPestleItem extends Item {
	public DiamondPestleItem() {
		super(new Item.Properties().durability(1024).attributes(ItemAttributeModifiers.builder().add(Attributes.ATTACK_DAMAGE, new AttributeModifier(BASE_ATTACK_DAMAGE_ID, -0.5, AttributeModifier.Operation.ADD_VALUE), EquipmentSlotGroup.MAINHAND)
