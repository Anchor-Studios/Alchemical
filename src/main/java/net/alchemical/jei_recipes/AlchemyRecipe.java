...
public class AlchemyRecipe implements Recipe<RecipeInput> {
	...
	public AlchemyRecipe(ItemStack output, NonNullList<Ingredient> recipeItems) {
		this.output = output;
	...
	public static class Type implements RecipeType<AlchemyRecipe> {
		...
		public static final RecipeType<AlchemyRecipe> INSTANCE = new Type();
	}

	public static class Serializer implements RecipeSerializer<AlchemyRecipe> {
		public static final Serializer INSTANCE = new Serializer();
		private static final MapCodec<AlchemyRecipe> CODEC = RecordCodecBuilder
				...
				}, DataResult::success).forGetter(recipe -> recipe.recipeItems)).apply(builder, AlchemyRecipe::new));
		public static final StreamCodec<RegistryFriendlyByteBuf, AlchemyRecipe> STREAM_CODEC = StreamCodec.of(Serializer::toNetwork, Serializer::fromNetwork);
		...
		private static AlchemyRecipe fromNetwork(RegistryFriendlyByteBuf buf) {
			...
			return new AlchemyRecipe(ItemStack.STREAM_CODEC.decode(buf), inputs);
		}
