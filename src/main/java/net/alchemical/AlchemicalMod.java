...
@Mod("alchemical")
public class AlchemicalMod {
	public static final Logger LOGGER = LogManager.getLogger(AlchemicalMod.class);
	public static final String MODID = "alchemical";

	public AlchemicalMod(IEventBus modEventBus) {
